# MarkdownPasteAddin v3.2 — 综合测试报告
...
| 文件 | 大小 | 状态 |
|------|------|------|
| background.js | 6,812 B | PASS |
| content_script.js | 13,037 B | PASS |
| docx-builder.js | 49,288 B | PASS |
| popup.js | 8,434 B | PASS |
| sidepanel.js | 4,253 B | PASS |
| options.js | 2,236 B | PASS |
| browser-polyfill.js | 6,383 B | PASS |
...
| 包名 | 大小 | 文件数 |
|------|------|--------|
| chrome-web-store.zip | 36,870 B | 17 |
| edge-addons.zip | 36,870 B | 17 |
...
*报告版本: 3.2 | 生成日期: 2026-06-15 | 测试工具: run_tests.py*
